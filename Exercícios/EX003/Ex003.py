# Ex003 Herança com Getters e Setters

'''Crie uma classe Ebook que herda da classe Livro do Exercício 1.
Adicione um atributo privado adicional chamado tamanho_arquivo(em MB).
Implemente getters e setters para este novo atributo.
'''
'''from Exercícios.modelos.classes import Livro, Ebook'''
from datetime import datetime
import os

file_path = (r"C:\Users\DPass\OneDrive\Área de Trabalho\IEFP\Programação Avançada em Python\Aulas Python "
             r"Avançado\Exercícios\EX003\Ex003.py")
